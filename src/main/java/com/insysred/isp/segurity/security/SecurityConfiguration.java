package com.insysred.isp.segurity.security;

import com.insysred.isp.segurity.security.jwt.JwtAuthenticationFilter;
import com.insysred.isp.segurity.security.jwt.JwtLoginFilter;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(
        ...
        return http
                ...
                .authorizeHttpRequests(request -> request.requestMatchers("/login","/api/v1/auth/**", "/v3/api-docs/**", "/swagger-ui/**", "/api/**").permitAll()
